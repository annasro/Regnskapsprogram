...
itemName = getInput(" Produktnavn/beskrivelse: ",df, str)
VAT_code =  getInput('Mvasats(høy, middels, lav, inten, unntatt):',df, str)
VAT_codes = {'Navn':itemName,  'Varenummer':product_no, 'Enhetspris':amount, 'Mva-type':VAT_code, 'Inntektskonto':b_accountno,'Varebeholdning':quantity,}
